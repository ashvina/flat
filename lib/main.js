...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.debug('*** ls ~/work/_actions/githubocto/flat/postprocessing/postprocess');
        core.debug(child_process_1.execSync('ls ~/work/_actions/githubocto/flat/postprocessing/postprocess').toString());
        core.debug(`*** ls __filename path: ${path_1.join(__filename, '../postprocess/shim.ts')}`);
