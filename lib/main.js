    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (config.postprocess) {
            ...
            try {
                ...
                filename = child_process_1.execSync(`deno run -A ./postprocessing_shim.ts ${config.postprocess} ${filename}`).toString();
            }
            catch (error) {
        ...
        yield exec_1.exec('git', ['add', '-A']); // TODO: should be filename instead of -A
